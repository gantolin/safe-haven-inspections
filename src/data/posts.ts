...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "A clean house — This might be surprising to some, but the next necessity for mold to begin to grow is food. Mold eats cellulose-based organic material, and dust and dirt can provide enough food for mold to get its roots in. Dust and dirt also happen to settle in the exact locations mold spores do, which is horizontal surfaces — the top of your baseboards or picture frames, for example. If you keep your house clean, you're removing an easy target for mold growth.",
      "Dehumidify — If you have a dehumidifier and a generator, great: use them if you're able to. For many who might not be so lucky, there are some natural ways to bring humidity down. One easy way is to remove indoor plants. There are also products you can purchase, like rock salt or DampRid, which you can pick up at a hardware store — simple, cheap, and great temporary tricks to keep humidity down.",
