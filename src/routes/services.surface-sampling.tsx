...
const faqs: FaqItem[] = [
  ...
  },
  {
    ...
    a: "Every job is different: the number of samples and whether they're collected during a full inspection or as a stand-alone visit both factor in. We give you a clear, upfront quote before any work begins, with no surprise fees. Call (561) 632-6387 or request an inspection for your property.",
  },
];
    ...
    <ServicePage
      ...
      intro={
        <>
          ...
          homeowner actually asks: what is this stain on my wall, and is it the
          bad kind? We collect material straight off the affected surface with a
          swab, tape lift, or bulk sample and send it to an accredited lab for
          species identification. Air testing tells you what is floating around.
          This tells you what is growing on the thing you are pointing at.
        </>
      }
      sections={[
        {
