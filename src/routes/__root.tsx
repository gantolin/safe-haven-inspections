...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Safe Haven Inspections LLC" },
...
function RootComponent() {
  ...
  useEffect(() => {
    ...
    const raf = requestAnimationFrame(() => {
      ...
      (window as unknown as { __shIO?: IntersectionObserver }).__shIO = io;
    });
    return () => {
      cancelAnimationFrame(raf);
      const w = window as unknown as { __shIO?: IntersectionObserver };
      w.__shIO?.disconnect();
    };
  }, [pathname]);
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col font-[Inter] text-foreground antialiased">
        <SiteNav />
